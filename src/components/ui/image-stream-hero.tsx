            ...
            Array.from({ length: cards }, (_, i) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    card, 
                    "absolute overflow-hidden rounded-xl border border-blue-500/30 bg-slate-900 shadow-xl shadow-slate-950/25"
                  )}
                  style={{
                    left: "50%",
                    top: `${axis}%`,
                  ...
                  {img ? (
                    <div className="relative h-full w-full group">
                      <img
                        ...
                        loading="lazy"
                        decoding="async"
                        className="h-full w-full object-cover brightness-90 hover:brightness-100 transition-all duration-300"
                        draggable={false}
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
                      {img.tag && (
                        <div className="absolute top-2 left-2 px-2 py-0.5 rounded text-[9px] font-semibold bg-blue-600 text-white shadow-sm">
                          {img.tag}
                        </div>
                      )}
                      {img.title && (
                        <div className="absolute bottom-2 left-2 right-2 text-[10px] font-medium text-white truncate drop-shadow">
                          {img.title}
                        </div>
                      )}
                    </div>
